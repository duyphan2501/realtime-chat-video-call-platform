...
const AuthLeft = () => {
  return (
    <div className="hidden lg:flex flex-col justify-between w-1/2 p-12 border-r border-gray-700 dark:border-gray-800">
      <div className="flex items-center gap-3 text-primary">
        <div className="size-8 mb-5">
          <Logo />
        </div>
        <h2 className="text-2xl font-black text-white tracking-tight dark:text-white mb-6">
          ConnectApp
        </h2>
      </div>
      ...
      <div className="max-w-lg">
        ...
        <div className="rounded-xl overflow-hidden shadow-2xl bg-white dark:bg-gray-800 h-100">
          <img
