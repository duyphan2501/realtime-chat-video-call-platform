...
export function ContactListSkeleton() {
  return (
    <div className="p-4">
      ...
      {/* Search skeleton */}
      <div className="h-10 w-full bg-slate-200 dark:bg-slate-800 rounded-lg animate-pulse mb-4" />
...
export function ContactDetailSkeleton() {
  return (
    <div className="flex flex-col items-center p-6">
      {/* Avatar skeleton */}
      <div className="w-24 h-24 rounded-full bg-slate-200 dark:bg-slate-700 animate-pulse mb-3" />
      
      {/* Name skeleton */}
      <div className="h-6 w-40 bg-slate-200 dark:bg-slate-700 rounded animate-pulse mb-2" />
      
      {/* Status skeleton */}
      <div className="h-4 w-20 bg-slate-200 dark:bg-slate-700 rounded animate-pulse mb-4" />

      {/* Action buttons */}
      <div className="flex gap-3 mt-4">
        {[1, 2, 3].map((i) => (
          <div key={i} className="w-16 h-16 rounded-2xl bg-slate-200 dark:bg-slate-700 animate-pulse" />
        ))}
      </div>
