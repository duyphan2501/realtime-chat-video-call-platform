...
const NAV_ITEMS: {
  ...
  },
  {
    ...
    Icon: ({ className }) => (
      <svg className={className} fill="currentColor" viewBox="0 0 20 20">
        <path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zm8 0a3 3 0 11-6 0 3 3 0 016 0zM2 16a6 6 0 0112 0H2zm8 0a6 6 0 0112 0H10z" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    Icon: ({ className }) => (
      <svg className={className} fill="currentColor" viewBox="0 0 20 20">
        <path
          fillRule="evenodd"
          d="M2 6a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1H2V6zm0 3h16v6a2 2 0 01-2 2H4a2 2 0 01-2-2V9z"
          clipRule="evenodd"
        />
      </svg>
    ),
...
function NavBtn({
  ...
  return (
    <div className="relative">
      ...
      {badge > 0 && (
        <span
          className="absolute top-0.5 right-0.5 min-w-4 h-4 flex items-center justify-center rounded-full text-white font-bold px-1"
