...
export default function RightPanel({
  ...
  const myRole = conv.participants.find(
  ...
  return (
    <div
      ...
      style={{
        width: 280,
        borderLeft: "1px solid var(--color-s3)",
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {/* Quick actions */}
        <div
          className="flex justify-center gap-4 px-4 pb-4"
          style={{ borderBottom: "1px solid var(--color-s3)" }}
        >
          {[
            ...
            <button
              key={a.label}
              className="flex flex-col items-center gap-1 p-2 rounded-2xl transition-colors group"
              onMouseEnter={(e) =>
                ...
                return (
                  ...
                  >
                    <img
                      src={
                        u?.avatar ||
                        `https://ui-avatars.com/api/?name=${encodeURIComponent(u?.name || "U")}&background=e3e8f0&color=0068FF&bold=true&size=32`
                      }
